...
export const Checkout = () => {
    ...
    return (
        ...
        <div className="rounded m-2 p-5 w-full max-w-2xl mx-auto bg-white shadow-lg rounded-sm border border-gray-200">
            {cartTotal() > 0 ?
                <div>
                    <div className="p-3">
                    ...
                    <form>
                        ...
                        <div className="mb-6">
                            <label className="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300">Teléfono</label>
                        ...
                        <div className="flex items-center">
                            ...
                            <label className="ml-2 text-sm font-medium text-gray-900 dark:text-gray-300 justify-center">Estoy de acuerdo con los <p className='text-blue-600 hover:underline dark:text-blue-500'>términos y cóndiciones</p></label>
                        </div>
                    </form>
                    <button type="submit" className="text-white bg-green-700 hover:bg-green-800 focus:ring-4 focus:outline-none focus:ring-green-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-blue-800" onClick={() => { sendOrder() }}>Enviar pedido!</button>
                </div>
