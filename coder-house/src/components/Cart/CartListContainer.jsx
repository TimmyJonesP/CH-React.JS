        ...
        <div className="h-full">
          <div className="w-full max-w-2xl mx-auto bg-white shadow-lg rounded-sm border border-gray-200">
            <header className="px-5 py-4 border-b border-gray-100">
              ...
              <h3 className="font-light text-gray-800"> Haga click en el item que desea modificar la cantidad ó elimine con el boton de la derecha.</h3>
            </header>
            <div className="p-3">
                ...
                <table className="table-auto w-full">
                  <thead className="text-xs font-semibold uppercase text-gray-400 bg-gray-50">
                    <tr>
                      ...
                      <th className="p-2 whitespace-nowrap">
                        <div className="font-semibold text-left">Precio total</div>
                      </th>
                      <th className="p-2 whitespace-nowrap">
              ...
              <Link to={"/checkout"} title="Finalizar Compra"><button type="submit" className="m-5 text-white bg-green-700 hover:bg-green-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800">Finalizar Compra</button></Link>
            </div>
          </div>
        </div>
